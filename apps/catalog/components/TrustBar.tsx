 ...
 *
 * Sets shopper expectations without alarm: browse freely and we deliver
 * across Thailand. Exported for reuse near the top of the home and shop
 * pages (placed by Task 12).
 *
  ...
  return (
    <div className="w-full border-b border-border bg-secondary">
      <p className="container py-2.5 text-center text-xs leading-relaxed text-muted-foreground sm:text-base">
        Browse freely + Thailand Express delivery
      </p>
    </div>
  );
}
