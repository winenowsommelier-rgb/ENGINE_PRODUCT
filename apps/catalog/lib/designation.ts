...
const DESIGNATION_PATTERNS: { label: string; re: RegExp }[] = [
  ...
  { label: 'DOCG',           re: /\bDOCG\b/i },
  { label: 'DOC',            re: /\bDOC\b/i },
  { label: 'IGT',            re: /\bIGT\b/i },
  { label: 'DOP/IGP',        re: /\b(?:DOP|IGP)\b/i },
  { label: 'AOC',            re: /\b(?:AOC|AOP)\b/i },
  { label: 'Single Malt',    re: /\bsingle\s+malt\b/i },
  { label: 'XO',             re: /\bXO\b/ },
  { label: 'VSOP',           re: /\bVSOP\b/ },
  { label: 'VS',             re: /\bVS\b/ },
  { label: 'Gran Reserva',   re: /\bgran\s+reserva\b/i },
  { label: 'Crianza',        re: /\bcrianza\b/i },
  { label: 'Classico',       re: /\bclassico\b/i },
  { label: 'Superiore',      re: /\bsuperiore\b/i },
