...
DESIGNATION_PATTERNS = [
    ...
    ("DOCG",        re.compile(r"\bDOCG\b", re.I)),
    ("DOC",         re.compile(r"\bDOC\b", re.I)),
    ("IGT",         re.compile(r"\bIGT\b", re.I)),
    ("DOP/IGP",     re.compile(r"\b(?:DOP|IGP)\b", re.I)),
    ("AOC",         re.compile(r"\b(?:AOC|AOP)\b", re.I)),
    ...
    ("Crianza",     re.compile(r"\bcrianza\b", re.I)),
    ("Classico",    re.compile(r"\bclassico\b", re.I)),
    ("Superiore",   re.compile(r"\bsuperiore\b", re.I)),
