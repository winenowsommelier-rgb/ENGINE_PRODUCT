...
# Local SQLite (products.db) uses the *_window column names — renamed from the
# legacy *_90d names. write_sqlite() UPDATEs popularity_qty_window /
# popularity_orders_window / popularity_revenue_window (see the NOTE in
# data/sync_popularity_from_bi.py and the live PRAGMA table_info(products)),
# so this fixture must create those exact columns or every write hits
# "no such column: popularity_qty_window".
POP_COLS = [
